  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>ROAD OBSTRUCTION</Text>
      </View>
        ...
        <View style={styles.boxesContainer}>
          <View style={styles.box}>
            <TouchableOpacity onPress={() => handleBoxClick(1)} style={styles.boxContent}>
              ...
              <View style={styles.boxeTextContainer}>
                <Text style={styles.boxesText}>"ROAD CLEARING"</Text>
          ...
          <View style={styles.box}>
            <TouchableOpacity onPress={() => handleBoxClick(2)} style={styles.boxContent}>
              ...
              <View style={styles.boxeTextContainer}>
                <Text style={styles.boxesText}>"DEAD ANIMAL"</Text>
                <Text style={styles.boxeText}>InProgress</Text>
                <SettingsIcon name="completed" size={10} color="green" style={styles.profileIcons} />
              </View>
            </TouchableOpacity>
          </View>
        </View>
